        ...
        <section className="about">
            ...
            <div className="about__container">
                <div className="about__mission">
                    ...
                    <p className="about__detail">We source our milk from our local farm. Our buffaloes are grass-fed and never given hormones, antibiotics, or injections for milk production.</p>
                </div>
