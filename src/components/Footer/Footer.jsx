        ...
        <section className="footer">
            ...
            <div className="footer__right">
                ...
                <div className="footer__section">
                    <p className="footer__subheading">not delivering in your area?</p>
                    <p className="footer__large">Subscribe to our newsletter</p>
                </div>
                <div className="footer__buttonArea">
                    <textarea className='footer__textbox' name="subscribe" id="subscribeBox"></textarea>
